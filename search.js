document.addEventListener("DOMContentLoaded", function () {
    ...
    const queryGuests = urlParams.get('guests') || "1 Guest 1 Room";
    ...
    fetchAndDisplayHotels(queryQ.toLowerCase(), initialNights, 1);
                    ...
                    <div class="card h-100 shadow-sm hotel-card">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto bg-light p-2 rounded">
                                ...
                                <p class="card-text mb-0 small">Total for ${nights} night(s) & ${guests} guest(s)</p>
                            </div>
                        </div>
                    </div>
                `;
